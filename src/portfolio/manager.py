            ...
            [
                ...
                (
                  ...
                  ```
                                    ...
                                    Output strictly in JSON with the following structure:                  {{\n                    "decisions": {{\n                      "TICKER1": {{\n                        "action": "buy/sell/short/cover/hold",\n                        "confidence": float between 0 and 100,\n                        "reasoning": "DETAILED reasoning at least 200 words long that includes comprehensive analysis of all analyst signals, risk factors, position context, and market outlook. MUST analyze each analyst by name and include specific quantitative data."\n                      }},\n                      "TICKER2": {{\n                        ...\n                      }},\n                      ...\n                    }}\n                  }}\n                  """
                ),
            ]
        )
