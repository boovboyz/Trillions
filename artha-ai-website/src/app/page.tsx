...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center w-full overflow-hidden">
      {/* Hero Section */}
      <section id="hero" className="w-full min-h-screen flex items-center justify-center py-12 md:py-16 lg:py-24 bg-gradient-to-bl from-indigo-950 via-gray-900 to-black text-white text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col items-center justify-center z-10 max-w-4xl">
          <div className="text-center w-full mb-6 md:mb-8 glass-hero-box p-6 md:p-10 rounded-xl">
            <h1 className="text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-semibold tracking-tight enhanced-glow-animated leading-tight">
              Algorithmic Precision
              <span className="block gradient-text bg-gradient-to-r from-indigo-400 via-cyan-400 to-pink-400 mt-2 md:mt-4 font-extrabold">Analytical Performance</span>
            </h1>
            <p className="mt-6 md:mt-8 mx-auto text-base md:text-lg lg:text-xl leading-relaxed max-w-3xl font-normal antialiased">
              VectorQuant AI is an Advanced Full-Stack, Agentic AI system for Automated Intelligent Investing & Portfolio Management<br className="hidden md:block" /><span className="font-bold gradient-text bg-gradient-to-r from-cyan-300 to-indigo-300">Maximize Potential, Control Risk, and Trade Smarter</span>
            </p>
          </div>
          
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 mt-6 md:mt-8 w-full md:w-auto">
            <a 
              href="#demo"
              onClick={(e: React.MouseEvent<HTMLAnchorElement>) => scrollToSection(e, 'demo')}
              className="group inline-flex items-center justify-center px-6 md:px-10 py-3 md:py-4 text-lg md:text-xl font-semibold text-white bg-gradient-to-r from-indigo-600 to-cyan-500 rounded-lg shadow-3d hover:from-indigo-700 hover:to-cyan-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all transform hover:scale-105 duration-300 ease-in-out w-full sm:w-auto enhanced-glow-animated"
            >
      ...
      {/* Features Section */}
      <section id="features" className="w-full py-16 md:py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {features.map((feature, index) => (
              <div 
                key={feature.title} 
                className="card-3d bg-white p-6 md:p-8 rounded-xl shadow-3d border border-gray-200 transition-all duration-300 flex flex-col items-center text-center group hover:border-transparent"
              ...
              >
                <div className={`mb-4 p-3 rounded-full ${feature.iconBgColor} inline-block depth-effect group-hover:bg-gradient-to-br group-hover:${feature.gradientClass} transition-all duration-300`}>
                  <feature.icon className={`w-6 h-6 md:w-8 md:h-8 ${feature.iconTextColor} group-hover:text-white transition-colors duration-300`} />
                </div>
                <h3 className="mb-2 text-lg md:text-xl font-semibold text-gray-900">{feature.title}</h3>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed flex-grow">{feature.description}</p>
      ...
      <section id="how-it-works" className="w-full py-16 md:py-20 lg:py-28 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
             <div className="card-3d space-y-4 md:space-y-6 bg-white p-6 md:p-8 rounded-xl shadow-3d border border-gray-200 flex flex-col items-center text-center h-full subtle-glow hover:border-transparent backdrop-blur-sm bg-white/95">
                {/* 3D visualization placeholder */}
                <div className="relative h-32 md:h-40 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg overflow-hidden depth-effect w-full">
                ...
                <h3 className="flex items-center justify-center text-lg md:text-2xl font-bold text-gray-800">
                  <Network className="w-5 h-5 md:w-7 md:h-7 mr-2 md:mr-3 text-indigo-600"/> 
             ...
             <div className="card-3d space-y-4 md:space-y-6 bg-white p-6 md:p-8 rounded-xl shadow-3d border border-gray-200 flex flex-col items-center text-center h-full subtle-glow hover:border-transparent backdrop-blur-sm bg-white/95">
                {/* 3D visualization placeholder */}
                <div className="relative h-32 md:h-40 bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg overflow-hidden depth-effect w-full">
                  <div className="absolute inset-0 flex items-center justify-center">
                ...
                <h3 className="flex items-center justify-center text-lg md:text-2xl font-bold text-gray-800">
                  <Scale className="w-5 h-5 md:w-7 md:h-7 mr-2 md:mr-3 text-pink-600"/> 
             ...
             <div className="card-3d space-y-4 md:space-y-6 bg-white p-6 md:p-8 rounded-xl shadow-3d border border-gray-200 flex flex-col items-center text-center h-full subtle-glow hover:border-transparent backdrop-blur-sm bg-white/95">
                {/* 3D visualization placeholder */}
                <div className="relative h-32 md:h-40 bg-gradient-to-br from-violet-50 to-violet-100 rounded-lg overflow-hidden depth-effect w-full">
                  <div className="absolute inset-0 flex items-center justify-center">
                ...
                <h3 className="flex items-center justify-center text-lg md:text-2xl font-bold text-gray-800">
                  <Bot className="w-5 h-5 md:w-7 md:h-7 mr-2 md:mr-3 text-violet-600"/> 
             ...
             <div className="card-3d space-y-4 md:space-y-6 bg-white p-6 md:p-8 rounded-xl shadow-3d border border-gray-200 flex flex-col items-center text-center h-full subtle-glow hover:border-transparent backdrop-blur-sm bg-white/95">
                {/* 3D visualization placeholder */}
                <div className="relative h-32 md:h-40 bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg overflow-hidden depth-effect w-full">
                ...
                <h3 className="flex items-center justify-center text-lg md:text-2xl font-bold text-gray-800">
                  <Activity className="w-5 h-5 md:w-7 md:h-7 mr-2 md:mr-3 text-cyan-600"/> 
      ...
      {/* Contact Section */}
      <section id="contact" className="w-full py-16 md:py-20 lg:py-28 bg-white relative overflow-hidden">
        {/* Subtle background patterns */}
        <div className="absolute inset-0 gradient-mesh opacity-30"></div>
        <div className="absolute inset-0 gradient-dots opacity-10"></div>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <div className="relative p-1 rounded-xl bg-gradient-to-r from-indigo-500 via-cyan-500 to-pink-500 shadow-3d enhanced-glow-animated">
              <div className="bg-white rounded-lg p-5 md:p-6 lg:p-8 shadow-inner backdrop-blur-sm">
                <ContactForm />
              </div>
            </div>
          </div>
